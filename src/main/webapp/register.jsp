...
<jsp:include page="/header.jsp" />
	...
	<section class="auth-container fade-in">
       ...
       title="Minimo 8 caratteri, almeno 1 maiuscola, 1 minuscola, 1 numero e 1 carattere speciale"> <label>Conferma Password</label> <input
				type="password" name="confirm" id="confirm" required>
			<p id="pass-check" class="auth-check"></p>

			<label>Telefono</label> <input type="tel" name="phone" 
