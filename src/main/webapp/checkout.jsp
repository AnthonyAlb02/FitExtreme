...
<link rel="stylesheet"
	href="<%= request.getContextPath() %>/utilities/css/checkout.css">
</head>
...
<body>
	...
	<section class="checkout-container fade-in">
		...
		<a href="<%= request.getContextPath() %>/catalogo" class="btn-primary">Torna
			al catalogo</a>
		...
		<div class="checkout-grid">
			...
			<div class="checkout-products">
				...
				<div class="checkout-item">
					...
					<div class="checkout-info">
						...
						<p>
							Quantità:
							<%= quantita.get(a.getIdArticolo()) %></p>
						<p class="price">
							€
							<%= a.getPrezzoListino() %></p>
					</div>
			...
			<div class="checkout-summary">
				...
				<div class="summary-row">
					<span>Totale prodotti</span> <span>€ <%= totale %></span>
				</div>

				<div class="summary-row">
					<span>Spedizione</span> <span>Gratis</span>
				</div>

				<div class="summary-total">
					<span>Totale finale</span> <span>€ <%= totale %></span>
				</div>

				<a href="<%= request.getContextPath() %>/confermaOrdine"
					class="btn-primary"> Procedi al pagamento </a>
